...
- `advancing_priority`: Integer 1-4 ranking for advancing outreach order. 1 = Show Advance, 2 = Production, 3 = Venue Contact, 4 = Promoter. Null for non-advancing contacts. See `ops/domain/advancing.md` for details.
